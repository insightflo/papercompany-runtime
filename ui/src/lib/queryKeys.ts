export const queryKeys = {
  ...
  agents: {
    ...
    adapterProviderModels: (companyId: string, adapterType: string, provider: string) =>
      ["agents", companyId, "adapter-provider-models", adapterType, provider] as const,
  ...
  missions: {
    list: (companyId: string, filters?: object) =>
      ["missions", companyId, filters ?? {}] as const,
  ...
  access: {
    ...
    memberSearch: (companyId: string, query: string) =>
      ["access", "member-search", companyId, query] as const,
    permissionGroups: (companyId: string) =>
      ["access", "permission-groups", companyId] as const,
    permissionGroup: (companyId: string, groupId: string) =>
      ["access", "permission-groups", companyId, groupId] as const,
  },
  auth: {
