...
import { collectWorkflowRunInputs } from "./workflow-run-input-prompts-legacy.js";
...
describe("collectManualRunLabel", () => {
  it("returns the trimmed label when entered", async () => {
    const { collectManualRunLabel } = await import("./workflow-run-input-prompts-legacy.js");
