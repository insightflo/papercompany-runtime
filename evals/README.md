...
Eval framework for testing papercompany agent behaviors across models and prompt versions.

See [the evals framework plan](../../papercompany-artifacts/doc/plans/2026-03-13-agent-evals-framework.md) for full design rationale.
...
Phase 0 covers narrow behavior evals for the papercompany heartbeat skill:
