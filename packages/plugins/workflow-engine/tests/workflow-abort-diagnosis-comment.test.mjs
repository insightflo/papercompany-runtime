...
test("workflow abort parent comments include main executor diagnosis instructions", () => {
  ...
  assert.match(source, /write the recovery\/replan path before restarting the workflow\./);
  assert.match(source, /Keep this parent oversight issue as the operator-facing record of the abort\./);
});
