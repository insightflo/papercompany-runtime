...
export const companyDataStorages = pgTable(
  "company_data_storages",
  {
  ...
  (table) => ({
    companyUq: uniqueIndex("company_data_storages_company_uq").on(table.companyId),
    companyProviderIdx: index("company_data_storages_company_provider_idx").on(
      table.companyId,
      table.provider,
    ),
  }),
