...
- Running a Python script that calls the papercompany API
...
1. papercompany spawns the configured command as a child process
...
The script can use the injected environment variables to authenticate with the papercompany API and perform work.
