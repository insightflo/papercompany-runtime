  ...
  async function ensureMainExecutorPlanningIssue(mission: MissionRow) {
    ...
    return issueService(db).create(mission.companyId, {
      ...
      description: [
        ...
        "- Evaluate available workflow tools, KB refs, agent roster skills, and company skill capabilities from the runtime planning dossier before selecting execution units.",
