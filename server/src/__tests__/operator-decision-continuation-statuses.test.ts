...
const cases: Array<[string, Record<string, unknown>, string, string | null, boolean]> = [
  ...
  ["run cancelled", { run: { status: "cancelled" } }, "cancelled", "heartbeat_cancelled", false],
  ["run timed out", { run: { status: "timed_out" } }, "timed_out", "heartbeat_timed_out", false],
  ["request completed", { wakeup: { status: "completed", runId: null } }, "completed", null, false],
  ["request skipped", { wakeup: { status: "skipped", runId: null } }, "skipped", "heartbeat_skipped", false],
  ...
  ["blocked + unassigned + issue later done is auto-skipped", { continuation: { state: "blocked", errorCode: "issue_unassigned" }, issue: { ...baseIssue, assigneeAgentId: null, status: "done" } }, "skipped", "issue_terminal", false],
  ["blocked + unassigned + issue later cancelled is auto-skipped", { continuation: { state: "blocked", errorCode: "issue_unassigned" }, issue: { ...baseIssue, assigneeAgentId: null, status: "cancelled" } }, "skipped", "issue_terminal", false],
  ["blocked + unassigned + issue still open stays actionable", { continuation: { state: "blocked", errorCode: "issue_unassigned" }, issue: { ...baseIssue, assigneeAgentId: null, status: "in_progress" } }, "blocked", "issue_unassigned", true],
